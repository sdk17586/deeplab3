...
class Trainer():
    ...
    def setHyperParam(self):
        ...
        self.originWeightPath = "/data/sungmin/deeplabv3/originWeight"
        # make weightPath
...
if __name__ == "__main__":
    ...
    try:
        # img
        data = '{"runType":"train","dataInfo":{"purposeType":"segmentation","classInfo":[{"classId":"9511c","className":"cat","color":"#ef8783","desc":"","dsId":"e3375","dsName":"[CLF] LG\uc5d4\uc194_Train_dataset","isClick":false,"showTf":true},{"classId":"66a0e","className":"dog","color":"#0000ff","desc":"","dsId":"e337e","dsName":"[CLF] LG\uc5d4\uc194_Train_dataset","isClick":false,"showTf":true}],"mlType":"vision","sourceType":"file"},"servInfo":{"servIp":"string","servPort":"string","sendResultUrl":"string","sendStatusUrl":"string"},"pathInfo":{"trainPathList":["/data/sungmin/deeplabv3/sample/img"],"modelPath":"/data/sungmin/deeplabv3/model","weightPath":"/data/sungmin/deeplabv3/weight","logPath":"/data/sungmin/deeplabv3/log/log.log","pvPath":"/data/sungmin/deeplabv3"},"selectedHyperParam":{"epoch":1000,"batchSize":1,"trainRate":{"train":70,"validation":30},"grayScale":"false","optimizer":"adam","learningRate":0.001,"earlyStopping":"true","patience":10,"monitor":"accuracy","gpuIdx":"auto"},"useClassBalancer":false}'
